...
Primer koji će biti analiziran jeste rad jednostavnog distribuiranog DNS servera\footnote{Usled složenosti implementacije distribuiranog PostgreSQL sistema, za distribuirano okruženje primer je dat samo za HBase, a upoređivanje je dato na osnovu teorijskih istraživanja}.
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\textwidth]{olap-vizualization2.png}
  \caption{OLAP}
  \label{fig:grafikon}
\end{figure}
